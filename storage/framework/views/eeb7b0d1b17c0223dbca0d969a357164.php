        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex justify-between mt-4 col-6">
                    <form action="<?php echo e(route('addons.index')); ?>" method="GET" class="flex items-center">
                    ...
                    <a href="<?php echo e(route('addons.create')); ?>" class="m-2 btn btn-success">
                ...
                <table class="table">
                  ...
                  <tbody class="table-tbody">
                    ...
                    <tr>
                      ...
                      <td><?php echo e($addon->addon_str); ?></td>
                      <td><?php echo e($addon->description); ?></td>
                      <td>
                        <div class="mr-2" role="group" aria-label="User Actions">
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('addons.show', $addon->id)); ?>" class="btn btn-primary" role="button">
                                  <i class="fas fa-eye"></i> View
                                </a>
                            </div>
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('addons.edit', $addon->id)); ?>" class="btn btn-secondary" role="button">
                                  <i class="fas fa-pencil-alt"></i> Edit
                                </a>
                            </div>
                            <form action="<?php echo e(route('addons.destroy', $addon->id)); ?>" method="POST" class="inline">
                              <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\UKPBJ\Herd\facility_reservation\resources\views\addons\index.blade.php ENDPATH**/ ?>