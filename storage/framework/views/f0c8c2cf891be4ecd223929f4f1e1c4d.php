        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex justify-between mt-4 col-6">
                    <form action="<?php echo e(route('uker_masters.index')); ?>" method="GET" class="flex items-center">
                    ...
                    <a href="<?php echo e(route('uker_masters.create')); ?>" class="m-2 btn btn-success">
                ...
                <table class="table">
                  ...
                  <tbody class="table-tbody">
                    ...
                    <tr>
                      ...
                      <td class="sort-satker"><?php echo e($ukerMaster->satkerMaster->nama_satker); ?></td>
                      <td class="sort-kd_satker"><?php echo e($ukerMaster->satkerMaster->kd_satker); ?></td>
                      <td class="sort-actions">
                        <div class="mr-2" role="group" aria-label="User Actions">
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('uker_masters.show', $ukerMaster->id)); ?>" class="btn btn-primary" role="button">
                                  <i class="fas fa-eye"></i> View
                                </a>
                            </div>
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('uker_masters.edit', $ukerMaster->id)); ?>" class="btn btn-secondary" role="button">
                                  <i class="fas fa-pencil-alt"></i> Edit
                                </a>
                            </div>
                            <form action="<?php echo e(route('uker_masters.destroy', $ukerMaster->id)); ?>" method="POST" class="inline">
                              <?php echo csrf_field(); ?>
              ...
              <div class="m-4"  >
                <?php echo e($ukerMasters->links()); ?> <!-- Pagination Links -->
              </div>
            </div>
          </div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\UKPBJ\Herd\facility_reservation\resources\views\uker_masters\index.blade.php ENDPATH**/ ?>