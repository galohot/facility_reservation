                                ...
                                <tr>
                                    <td class="sort-status">
                                        <?php switch($reservation->status):
                                            case ('pending'): ?>
                                                <span class="text-white badge bg-warning"><?php echo e(strtoupper($reservation->status)); ?></span>
                                                <?php break; ?>
                                            <?php case ('approved'): ?>
                                                <span class="text-white badge bg-success"><?php echo e(strtoupper($reservation->status)); ?></span>
                                                <?php break; ?>
                                            <?php case ('rejected'): ?>
                                                <span class="text-white badge bg-danger"><?php echo e(strtoupper($reservation->status)); ?></span>
                                                <?php break; ?>
                                            <?php default: ?>
                                                <span><?php echo e(strtoupper($reservation->status)); ?></span>
                                        <?php endswitch; ?>
                                    </td>
                                    <td class="sort-facility"><a href="<?php echo e(route('facilities.show', $reservation->facility->id)); ?>"><?php echo e($reservation->facility->name); ?></a></td>
                                    <td class="sort-event"><?php echo e($reservation->event); ?></td>
                                    <td class="sort-start"><?php echo e($reservation->reservation_start->translatedFormat('l, j F Y, H:i')); ?></td>
                                    <td class="sort-end"><?php echo e($reservation->reservation_end->translatedFormat('l, j F Y, H:i')); ?></td>
                                    <td class="sort-pemohon">
                                        <span><h6><?php echo e($reservation->user->name); ?></h6></span>
                                        <span><h6><?php echo e($reservation->user->ukerMaster->nama_unit_kerja_eselon_2); ?></h6></span>
                                        <span class="text-blue"><?php echo e($reservation->user->email); ?></span>
                                    </td>
                                    <td class="sort-manager"><?php echo e($reservation->facility->ukerMaster->nama_unit_kerja_eselon_2); ?></td>
                                    <td class="sort-actions">
                                        <div class="mr-2" role="group" aria-label="User Actions">
                                            ...
                                            <?php endif; ?>
                                            <?php if(auth()->check() && (auth()->user()->hasRole('admin') || auth()->user()->hasRole('manager') || auth()->check() && (auth()->user()->hasRole('verificator')))): ?>
                                            <div class="m-1 d-block">
                                                <?php if(auth()->user()->hasRole('admin')): ?>
                                                <a href="<?php echo e(route('reservations.admin.verify', $reservation->id)); ?>" class="btn btn-info" role="button">
                                                    <i class="fas fa-pencil-alt"></i> Verify
                                                </a>
                                            <?php elseif(auth()->user()->hasRole('manager') || auth()->user()->hasRole('verificator')): ?>
                                                <a href="<?php echo e(route('reservations.verify', $reservation->id)); ?>" class="btn btn-info" role="button">
                                                    <i class="fas fa-pencil-alt"></i> Verify
                                                </a>
                                            <?php endif; ?>
                                            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\UKPBJ\Herd\facility_reservation\resources\views\landing\content\user-reservation.blade.php ENDPATH**/ ?>