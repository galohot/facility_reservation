        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex justify-between mt-4 col-6">
                    <form action="<?php echo e(route('facility_categories.index')); ?>" method="GET" class="flex items-center">
                    ...
                    <a href="<?php echo e(route('facility_categories.create')); ?>" class="m-2 btn btn-success">
              ...
              <div id="table-default" class="table-responsive">
                <table class="table">
                  ...
                  <tbody class="table-tbody">
                    ...
                    <tr>
                      <td><?php echo e($facilityCategory->id); ?></td>
                      <td><?php echo e($facilityCategory->category_str); ?></td>
                      <td><?php echo e($facilityCategory->facilities->count()); ?></td>
                      <td>
                        <div class="mr-2" role="group" aria-label="User Actions">
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('facility_categories.show', $facilityCategory->id)); ?>" class="btn btn-primary" role="button">
                                  <i class="fas fa-eye"></i> View
                                </a>
                            </div>
                            <div class="m-1 d-block">
                                <a href="<?php echo e(route('facility_categories.edit', $facilityCategory->id)); ?>" class="btn btn-secondary" role="button">
                                  <i class="fas fa-pencil-alt"></i> Edit
                                </a>
                            </div>
                            <form action="<?php echo e(route('facility_categories.destroy', $facilityCategory->id)); ?>" method="POST" class="inline">
                              <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\UKPBJ\Herd\facility_reservation\resources\views\facility_categories\index.blade.php ENDPATH**/ ?>