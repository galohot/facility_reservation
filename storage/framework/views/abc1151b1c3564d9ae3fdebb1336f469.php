                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <a href="<?php echo e(route('reservations.create')); ?>?facility_id=<?php echo e($facility->id); ?>"
                                class="my-2 btn btn-success">Make reservation</a>
                            <?php if(Auth::user()->roleMaster->role_str == 'admin' ||
                                    (Auth::user()->roleMaster->role_str == 'manager' && $facility->ukerMaster->id == Auth::user()->ukerMaster->id)): ?>
                                <a href="<?php echo e(route('facilities.edit', $facility->id)); ?>" class="my-2 btn btn-info">Edit
                                    Facility</a>
                            <?php endif; ?>
                                        ...
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                <div class="text-secondary float-end">
                                                    <?php echo e($facility->updated_at->format('F j, Y, g:i a')); ?></div>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="<?php echo e(asset('storage/' . $facility->image_1)); ?>" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="<?php echo e(asset('storage/' . $facility->image_2)); ?>" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="<?php echo e(asset('storage/' . $facility->image_3)); ?>" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php $__currentLoopData = $limitedReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-2 text-center border">
                                                    <p><?php echo e($reservation->reservation_start->translatedFormat('l, j F Y, H:i')); ?>
                                                    ...
                                                    <div class="reservation-info"> <!-- Add this container -->
                                                        <strong><span class="text-white badge bg-success text-wrap"
                                                                style="display: inline-block; word-break: break-all;"><?php echo e($reservation->user->ukerMaster->nama_unit_kerja_eselon_2); ?></span></strong>
                                                    </div>
                                                    <br />
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                Category: <br />
                                                <strong><?php echo e($facility->facilityCategory->category_str); ?></strong>
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                Capacity <br />
                                                <strong><?php echo e($facility->capacity ? $facility->capacity : 'No data available'); ?></strong>
                                            </div>
                                            <div class="mb-2">
                                                Facility Manager <br />
                                                <strong><?php echo e($facility->ukerMaster->nama_unit_kerja_eselon_2); ?></strong>
                                            </div>
                                            <div class="mb-2">
                                                Satuan Kerja <br />
                                                <strong><?php echo e($facility->ukerMaster->satkerMaster->nama_satker); ?></strong>
                                            </div>
                                            <div class="mb-2">
                                                Addons: <br />
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php if($facility->google_map_link): ?>
                                                    <a href="<?php echo e($facility->google_map_link); ?>" target="_blank"><img
                                                            src="<?php echo e(asset('build/assets/img/google-maps.png')); ?>"
                                                            alt=""></a>
                                                <?php else: ?>
