                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p><strong>Nama Unit Kerja Eselon II</strong>
                                        <?php echo e($ukerMaster->nama_unit_kerja_eselon_2); ?></p>
                                    <p><strong>Nama Satuan Kerja Eselon I</strong>
                                        <?php echo e($ukerMaster->satkerMaster->nama_satker); ?></p>
                            ...
                            <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($facility->uker_masters_id == $ukerMaster->id): ?>
                                    <tr>
                                        ...
                                        <td class="sort-satker"><a href="<?php echo e(route('facilities.show', $facility->id)); ?>"
                                                class="btn btn-primary" role="button">
                                                <i class="fas fa-eye"></i> View
                                            </a></td>
                                    </tr>
