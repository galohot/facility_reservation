...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('slot', null, []); ?> 
        ...
        <section>
            <div class="col">
                <form class="card" action="<?php echo e(route('satker_masters.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\UKPBJ\Herd\facility_reservation\resources\views\satker_masters\create.blade.php ENDPATH**/ ?>