                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong>Reservation End: </strong><?php echo e($reservation->reservation_start->translatedFormat('l, j F Y, H:i')); ?></p>
                                    ...
                                    <p>
                                        ...
                                        <?php switch($reservation->status):
                                            case ('pending'): ?>
                                                <span class="badge bg-warning text-white"><?php echo e(strtoupper($reservation->status)); ?></span>, Verificator: <span class="badge bg-info text-white"><?php echo e($reservation->facility->ukerMaster->nama_unit_kerja_eselon_2); ?></span>
                                                <?php break; ?>
                                            <?php case ('approved'): ?>
                                                <span class="badge bg-success text-white"><?php echo e(strtoupper($reservation->status)); ?></span>, Verificator: <span class="badge bg-info text-white"><?php echo e($reservation->facility->ukerMaster->nama_unit_kerja_eselon_2); ?></span>
                                                <?php break; ?>
                                            <?php case ('rejected'): ?>
                                                <span class="badge bg-danger text-white"><?php echo e(strtoupper($reservation->status)); ?></span>, Verificator: <span class="badge bg-info text-white"><?php echo e($reservation->facility->ukerMaster->nama_unit_kerja_eselon_2); ?></span>
                                                <?php break; ?>
                                            <?php default: ?>
                                    ...
                                    <p><a href="<?php echo e(url(Storage::url($reservation->document))); ?>" target="_blank">Download Document</a></p>
                                    <?php endif; ?>
                                    <!-- Add a link to download the document attachment -->
                                    <?php if($reservation->document_attachment): ?>
                                        <p><a href="<?php echo e(Storage::url($reservation->document_attachment)); ?>" target="_blank">Download Document Attachment</a></p>
                                    <?php endif; ?>
                                    <!-- Buttons for verifying and rejecting -->
                                    <?php if(auth()->check() && (auth()->user()->hasRole('admin'))): ?>
                                    <form method="POST" action="<?php echo e(route('reservations.admin.verify', $reservation->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('reservations.verify', $reservation->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <div class="mb-4">
                                            <label class="form-label required" for="description">Description</label>
