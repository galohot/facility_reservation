            ...
            <form action="<?php echo e(route('landing.search')); ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-3">
                        ...
                        <input type="datetime-local" name="start_date" id="start_date" class="form-control" value="<?php echo e(old('start_date', $startDate ?? '')); ?>">
                    </div>
                    <div class="form-group col-3" id="end-date-group" style="<?php echo e(old('end_date', $endDate ?? '') ? 'display:block;' : 'display:none;'); ?>">
                        <label for="end_date">End Date</label>
                        <p>(Fill in the end date)</p>
                        <input type="datetime-local" name="end_date" id="end_date" class="form-control" value="<?php echo e(old('end_date', $endDate ?? '')); ?>">
                    </div>
                </div>
                <div class="my-3 form-group col-3 d-flex align-items-end">
                    <button type="button" id="toggle-end-date" class="btn btn-secondary"><?php echo e(old('end_date', $endDate ?? '') ? 'Remove End Date' : 'Add End Date'); ?></button>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-9">
                                    <div class="card-body">
                                        ...
                                        <?php if( time() < strtotime($reservation->reservation_start) && strtotime($reservation->reservation_start) < $startDate && $startDate > time()): ?>
                                        <p>upcoming reservation: <span class="text-white badge bg-warning"><?php echo e($reservation->reservation_start->translatedFormat('l, j F Y, H:i')); ?></span> to <span class="text-white badge bg-warning"><?php echo e($reservation->reservation_end->translatedFormat('l, j F Y, H:i')); ?></span></p>
                                        <?php break; ?>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
