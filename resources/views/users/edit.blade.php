                                            ...
                                            <select name="uker_master_id" id="uker_master_id" class="form-select"
                                                ...
                                                @foreach ($ukerMasters as $ukerMaster)
                                                    <option value="{{ $ukerMaster->id }}"
                                                        {{ $user->uker_master_id == $ukerMaster->id ? 'selected' : '' }}>
                                                        {{ $ukerMaster->nama_unit_kerja_eselon_2 }},
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="role_master_id" id="role_master_id" class="form-select"
                                                ...
                                                @foreach ($roleMasters as $roleMaster)
                                                    <option value="{{ $roleMaster->id }}"
                                                        {{ $user->role_master_id == $roleMaster->id ? 'selected' : '' }}>
                                                        {{ $roleMaster->role_str }}</option>
                                                @endforeach
                                            </select>
                                        </div>
