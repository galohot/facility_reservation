<x-landing-layout>
    ...
    <x-slot name="slot">
        <div>
            ...
            <form action="{{ secure_url(route('landing.search') }}" method="POST">
                @csrf
                <div class="row">
                            ...
                            <div class="my-1 card">
                                <div class="row g-0">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ secure_url(route('reservation.make') }}?facility_id={{ $facility->id }}"
                                            class="my-2 btn btn-success w-100">Make Reservation</a>
                                        <a href="{{ secure_url(route('facility.page', $facility->id) }}"
