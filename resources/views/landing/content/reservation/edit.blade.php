        ...
        <section>
            <div class="col">
                <form class="card" id="reservationForm"
                    action="{{ route('landing.reservation.update', $reservation->id) }}" method="POST"
                            ...
                            <div id="facilityCard" style="display:none;" class="my-2 col">
                                ...
                                <div class="mb-4 col col-md-6">
                                    ...
                                    <input type="text" name="reservation_start" id="reservation_start"
                                        value="{{ $reservation->reservation_start }}" class="form-control flatpickr">
                                </div>
                                <div class="mb-4 col col-md-6">
                                    <label class="form-label" for="reservation_end">Event Ends</label>
                                    <input type="text" name="reservation_end" id="reservation_end"
                                        value="{{ $reservation->reservation_end }}" class="form-control flatpickr">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <p
                                        class="badge {{ $reservation->document ? 'bg-success' : 'bg-danger' }} text-white">
                ...
                if (facilityId) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#facilityImage').attr('src', '{{ asset('storage') }}/' + response.facility
                                .image_main);
                            $('#viewFacilityLink').attr('href', '{{ route('facility.page', '') }}/' +
