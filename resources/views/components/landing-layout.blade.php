                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ secure_url(route('reservation.myreservation') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                            ...
                            @endif
                            <li class="nav-item">
                                <a class="nav-link" href="{{ secure_url(route('landing.calendar') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ secure_url(route('landing.dashboard') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                        ...
                                        <div class="dropdown-menu-column">
                                            @foreach ($navItems as $navItem)
                                                <a class="dropdown-item"
                                                    href="{{ secure_url(route('available.facilities.show', $navItem->id) }}">
