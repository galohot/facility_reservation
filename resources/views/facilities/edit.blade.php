<x-app-layout>
    <x-slot name="slot">
        ...
        <section>
            ...
            <div class="col">
                <form class="card" action="{{ secure_url(route('facilities.update', $facility->id) }}" method="POST" enctype="multipart/form-data">
                    <a href="{{ secure_url(route('facilities.index') }}" class="btn btn-secondary" role="button">
