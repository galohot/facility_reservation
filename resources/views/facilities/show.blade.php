              ...
              <div class="container">
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <a href="{{ secure_url(route('reservations.create') }}?facility_id={{ $facility->id }}" class="my-2 btn btn-success">Make reservation</a>
                    ...
                    <a href="{{ secure_url(route('facilities.edit', $facility->id) }}" class="my-2 btn btn-info">Edit Facility</a>
                    @endif
