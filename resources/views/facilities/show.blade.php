                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            @if (Auth::user()->roleMaster->role_str == 'admin' ||
                                ...
                                <a href="{{ route('facilities.edit', $facility->id) }}" class="my-2 btn btn-info">Edit
                                    Facility</a>
                            @endif
                                        ...
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                <div class="text-secondary float-end">
                                                    {{ $facility->updated_at->format('F j, Y, g:i a') }}</div>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="{{ asset('storage/' . $facility->image_1) }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="{{ asset('storage/' . $facility->image_2) }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="timeline-event">
                                        <div class="card timeline-event-card">
                                            <div class="card-body">
                                                ...
                                                <img src="{{ asset('storage/' . $facility->image_3) }}" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="col-lg-4">
                            <div class="row row-cards">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @foreach ($limitedReservations as $reservation)
                                                <div class="mb-2 text-center border">
                                                    <p>{{ $reservation->reservation_start->translatedFormat('l, j F Y, H:i') }}
                                                        <br /> s/d
                                                    ...
                                                    <div class="reservation-info"> <!-- Add this container -->
                                                        <strong><span class="text-white badge bg-success text-wrap"
                                                                style="display: inline-block; word-break: break-all;">{{ $reservation->user->ukerMaster->nama_unit_kerja_eselon_2 }}</span></strong>
                                                    </div>
                                                    <br />
                                                </div>
                                            @endforeach
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="card-title">{{ $pageTitle }} info</div>
                                            <div class="mb-2">
                                                Category: <br />
                                                <strong>{{ $facility->facilityCategory->category_str }}</strong>
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                Capacity <br />
                                                <strong>{{ $facility->capacity ? $facility->capacity : 'No data available' }}</strong>
                                            </div>
                                            <div class="mb-2">
                                                Facility Manager <br />
                                                <strong>{{ $facility->ukerMaster->nama_unit_kerja_eselon_2 }}</strong>
                                            </div>
                                            <div class="mb-2">
                                                Satuan Kerja <br />
                                                <strong>{{ $facility->ukerMaster->satkerMaster->nama_satker }}</strong>
                                            </div>
                                            <div class="mb-2">
                                                Addons: <br />
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="card-title">{{ $pageTitle }} Location</div>
                                            <div class="card-body">
                                                <h4>{{ $facility->location }}</h4>
                                                @if ($facility->google_map_link)
                                                    <a href="{{ $facility->google_map_link }}" target="_blank"><img
                                                            src="{{ asset('build/assets/img/google-maps.png') }}"
                                                            alt=""></a>
                                                @else
