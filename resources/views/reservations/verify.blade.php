                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ secure_url(route('reservations.admin.verify', $reservation->id)}}">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-4">
                                    ...
                                    <form method="POST" action="{{ secure_url(route('reservations.verify', $reservation->id) }}">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-4">
                                            <label class="form-label required" for="description">Description</label>
