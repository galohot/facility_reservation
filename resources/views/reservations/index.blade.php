                            ...
                            @foreach ($reservations as $reservation)
                                @if (auth()->user()->hasRole('admin') ||
                                    ...
                                    <tr>
                                        ...
                                        <td class="sort-end">
                                            {{ $reservation->reservation_end->translatedFormat('l, j F Y, H:i') }}</td>
                                        <td class="sort-pemohon">
                                            <span>
                                                <h6>{{ $reservation->user->name }}</h6>
                                            </span>
                                            <span>
                                                <h6>{{ $reservation->user->ukerMaster->nama_unit_kerja_eselon_2 }}</h6>
                                            </span>
                                            <span class="text-blue">{{ $reservation->user->email }}</span>
                                        </td>
                                        <td class="sort-manager">
                                            {{ $reservation->facility->ukerMaster->nama_unit_kerja_eselon_2 }}</td>
