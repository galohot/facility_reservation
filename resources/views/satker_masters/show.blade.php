                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ secure_url('satker_masters.edit', $satkerMaster->id) }}" class="btn btn-primary">edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      @foreach ($ukerMasters as $ukerMaster)
                        @if ($satkerMaster->kd_satker == $ukerMaster->satker_master_kd_satker)
                            <tr>
                                ...
                                <td class="sort-satker"><a href="{{ secure_url('uker_masters.show', $ukerMaster->id) }}" class="btn btn-primary" role="button">
