            ...
            <div class="content">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <a href="{{ secure_url(route('uker_masters.index') }}" class="btn btn-secondary" role="button">
                                ...
                                <div class="card-body">
                                    <form action="{{ secure_url(route('uker_masters.update', $ukerMaster->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-3">
