            ...
            <div class="content">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <a href="{{ route('uker_masters.index') }}" class="btn btn-secondary" role="button">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('uker_masters.update', $ukerMaster->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_unit_kerja_eselon_2"
                                                ...
                                                value="{{ $ukerMaster->nama_unit_kerja_eselon_2 }}" required>
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <select name="satker_master_kd_satker" id="satker_master_kd_satker"
                                                ...
                                                @foreach ($satkerMasters as $satkerMaster)
                                                    <option value="{{ $satkerMaster->kd_satker }}"
                                                        {{ $ukerMaster->satker_master_kd_satker == $satkerMaster->kd_satker ? 'selected' : '' }}>
